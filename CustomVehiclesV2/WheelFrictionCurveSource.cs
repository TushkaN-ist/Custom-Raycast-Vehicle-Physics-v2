...
public class WheelFrictionCurveSource
{
	...
	public float m_extremumSlip; //Extremum point slip (default 3).
    public float m_extremumValue; //Force at the extremum slip (default 6000).
    public float m_asymptoteSlip; //Asymptote point slip (default 4).
    public float m_asymptoteValue; //Force at the asymptote slip (default 5500).
    public float m_stiffness; //Multiplier for the extremumValue and asymptoteValue values (default 1).
